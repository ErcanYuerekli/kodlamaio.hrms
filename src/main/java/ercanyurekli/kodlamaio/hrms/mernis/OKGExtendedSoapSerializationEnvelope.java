...
public class OKGExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(OKGDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new OKGStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static OKGDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static OKGDateTimeConverter dateTimeConverter = new OKGStandardDateTimeConverter();

    public OKGExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public OKGExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new OKGMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=OKGHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,OKGExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=OKGHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
