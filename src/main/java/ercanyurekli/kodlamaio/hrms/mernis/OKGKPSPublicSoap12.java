package ercanyurekli.kodlamaio.hrms.mernis;
...
public class OKGKPSPublicSoap12
{
    interface OKGIWcfMethod
    {
        OKGExtendedSoapSerializationEnvelope CreateSoapEnvelope() throws java.lang.Exception;

        java.lang.Object ProcessResult(OKGExtendedSoapSerializationEnvelope __envelope,java.lang.Object result) throws java.lang.Exception;
    }
    ...
    public OKGKPSPublicSoap12(){}

    public OKGKPSPublicSoap12(String url)
    {
        this.url = url;
    }

    public OKGKPSPublicSoap12(String url,int timeOut)
    {
        this.url = url;
    ...
    protected OKGExtendedSoapSerializationEnvelope createEnvelope()
    {
        OKGExtendedSoapSerializationEnvelope envelope= new OKGExtendedSoapSerializationEnvelope(OKGExtendedSoapSerializationEnvelope.VER12);
        envelope.enableLogging = enableLogging;
    
        return envelope;
    }

    protected java.util.List sendRequest(String methodName,OKGExtendedSoapSerializationEnvelope envelope,org.ksoap2.transport.Transport transport ,com.easywsdl.exksoap2.ws_specifications.profile.WS_Profile profile )throws java.lang.Exception
    {
    ...
    java.lang.Object getResult(java.lang.Class destObj,java.lang.Object source,String resultName,OKGExtendedSoapSerializationEnvelope __envelope) throws java.lang.Exception
    {
        if(source==null)
        {
            return null;
    ...
    public Boolean TCKimlikNoDogrula(final Long TCKimlikNo,final String Ad,final String Soyad,final Integer DogumYili) throws java.lang.Exception
    {
        ...
        return (Boolean)execute(new OKGIWcfMethod()
        {
            @Override
            public OKGExtendedSoapSerializationEnvelope CreateSoapEnvelope(){
                OKGExtendedSoapSerializationEnvelope __envelope = createEnvelope();
            ...
            @Override
            public java.lang.Object ProcessResult(OKGExtendedSoapSerializationEnvelope __envelope,java.lang.Object __result)throws java.lang.Exception {
    ...
    protected java.lang.Object execute(OKGIWcfMethod wcfMethod,String methodName,com.easywsdl.exksoap2.ws_specifications.profile.WS_Profile profile) throws java.lang.Exception
    {
        org.ksoap2.transport.Transport __httpTransport=createTransport();
        __httpTransport.debug=enableLogging;
        OKGExtendedSoapSerializationEnvelope __envelope=wcfMethod.CreateSoapEnvelope();
        try
        {
    ...
    protected java.lang.Exception convertToException(org.ksoap2.SoapFault fault,OKGExtendedSoapSerializationEnvelope envelope)
    {
