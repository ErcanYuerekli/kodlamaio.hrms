...
public class OKGKPSPublicSoap
{
    ...
    public OKGKPSPublicSoap(){}

    public OKGKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public OKGKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        OKGExtendedSoapSerializationEnvelope envelope= new OKGExtendedSoapSerializationEnvelope(OKGExtendedSoapSerializationEnvelope.VER11);
